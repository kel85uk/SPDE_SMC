...
<html>
  <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# githubog: http://ogp.me/ns/fb/githubog#">
    ...
    <meta content="collector.githubapp.com" name="octolytics-host" /><meta content="collector-cdn.github.com" name="octolytics-script-host" /><meta content="github" name="octolytics-app-id" /><meta content="83BC180C:3B1E:258594:529E6BFA" name="octolytics-dimension-request_id" />
...
<meta content="DfPKaa56LKU2K2O8eg6kuZcHzM/p5kaSrcFD40l0rpE=" name="csrf-token" />
    ...
    <link href="https://github.global.ssl.fastly.net/assets/github2-62c6a6e51e09f7f4ac5a95b9e7abe014c87b163f.css" media="all" rel="stylesheet" type="text/css" />
      ...
      <meta http-equiv="x-pjax-version" content="0c1382b9ce5023d36bc5adabb0f11f34">
        ...
        <link data-pjax-transient rel='permalink' href='/jedbrown/cmake-modules/blob/d510bc35b9952c8224f994bb122ab625e132cfb2/FindGSL.cmake'>
  ...
  <div class="container clearfix">
    ...
    <div class="header-actions">
      ...
      <a class="button signin" href="/login?return_to=%2Fjedbrown%2Fcmake-modules%2Fblob%2Fmaster%2FFindGSL.cmake">Sign in</a>
    </div>
...
<!-- blob contrib key: blob_contributors:v21:a76073bf6527beb07abdcb4c22b787d4 -->
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <div class="select-menu-item js-navigation-item selected">
              <span class="select-menu-item-icon octicon octicon-check"></span>
              <a href="/jedbrown/cmake-modules/blob/master/FindGSL.cmake"
                 data-name="master"
                 data-skip-pjax="true"
                 rel="nofollow"
      ...
      <div class="actions">
        <div class="button-group">
            <a class="minibutton tooltipped leftwards js-conduit-openfile-check"
               ...
               data-url="github-mac://openRepo/https://github.com/jedbrown/cmake-modules?branch=master&amp;filepath=FindGSL.cmake"
          ...
          <a href="/jedbrown/cmake-modules/raw/master/FindGSL.cmake" class="button minibutton " id="raw-url">Raw</a>
            <a href="/jedbrown/cmake-modules/blame/master/FindGSL.cmake" class="button minibutton ">Blame</a>
          <a href="/jedbrown/cmake-modules/commits/master/FindGSL.cmake" class="button minibutton " rel="nofollow">History</a>
        </div><!-- /.button-group -->
...
<span id="L32" rel="#L32">32</span>
            ...
            <td class="blob-line-code">
                    <div class="highlight"><pre><div class='line' id='LC1'><span class="c"># - Find GSL</span></div><div class='line' id='LC2'><span class="c"># Find the native GSL includes and library</span></div><div class='line' id='LC3'><span class="err">#</span></div><div class='line' id='LC4'><span class="c">#  GSL_INCLUDES    - where to find gsl/gsl_*.h, etc.</span></div><div class='line' id='LC5'><span class="c">#  GSL_LIBRARIES   - List of libraries when using GSL.</span></div><div class='line' id='LC6'><span class="c">#  GSL_FOUND       - True if GSL found.</span></div><div class='line' id='LC7'><br/></div><div class='line' id='LC8'><br/></div><div class='line' id='LC9'><span class="nb">if</span> <span class="p">(</span><span class="s">GSL_INCLUDES</span><span class="p">)</span></div><div class='line' id='LC10'>&nbsp;&nbsp;<span class="c"># Already in cache, be silent</span></div><div class='line' id='LC11'>&nbsp;&nbsp;<span class="nb">set</span> <span class="p">(</span><span class="s">GSL_FIND_QUIETLY</span> <span class="s">TRUE</span><span class="p">)</span></div><div class='line' id='LC12'><span class="nb">endif</span> <span class="p">(</span><span class="s">GSL_INCLUDES</span><span class="p">)</span></div><div class='line' id='LC13'><br/></div><div class='line' id='LC14'><span class="nb">find_path</span> <span class="p">(</span><span class="s">GSL_INCLUDES</span> <span class="s">gsl/gsl_math.h</span><span class="p">)</span></div><div class='line' id='LC15'><br/></div><div class='line' id='LC16'><span class="nb">find_library</span> <span class="p">(</span><span class="s">GSL_LIB</span> <span class="s">NAMES</span> <span class="s">gsl</span><span class="p">)</span></div><div class='line' id='LC17'><br/></div><div class='line' id='LC18'><span class="nb">set</span> <span class="p">(</span><span class="s">GSL_CBLAS_LIB</span> <span class="s2">&quot;&quot;</span> <span class="s">CACHE</span> <span class="s">FILEPATH</span> <span class="s2">&quot;If your program fails to link</span></div><div class='line' id='LC19'><span class="s2">(usually because GSL is not automatically linking a CBLAS and no other</span></div><div class='line' id='LC20'><span class="s2">component of your project provides a CBLAS) then you may need to point</span></div><div class='line' id='LC21'><span class="s2">this variable to a valid CBLAS.  Usually GSL is distributed with</span></div><div class='line' id='LC22'><span class="s2">libgslcblas.{a,so} (next to GSL_LIB) which you may use if an optimized</span></div><div class='line' id='LC23'><span class="s2">CBLAS is unavailable.&quot;</span><span class="p">)</span></div><div class='line' id='LC24'><br/></div><div class='line' id='LC25'><span class="nb">set</span> <span class="p">(</span><span class="s">GSL_LIBRARIES</span> <span class="s2">&quot;${GSL_LIB}&quot;</span> <span class="s2">&quot;${GSL_CBLAS_LIB}&quot;</span><span class="p">)</span></div><div class='line' id='LC26'><br/></div><div class='line' id='LC27'><span class="c"># handle the QUIETLY and REQUIRED arguments and set GSL_FOUND to TRUE if</span></div><div class='line' id='LC28'><span class="c"># all listed variables are TRUE</span></div><div class='line' id='LC29'><span class="nb">include</span> <span class="p">(</span><span class="s">FindPackageHandleStandardArgs</span><span class="p">)</span></div><div class='line' id='LC30'><span class="nb">find_package_handle_standard_args</span> <span class="p">(</span><span class="s">GSL</span> <span class="s">DEFAULT_MSG</span> <span class="s">GSL_LIBRARIES</span> <span class="s">GSL_INCLUDES</span><span class="p">)</span></div><div class='line' id='LC31'><br/></div><div class='line' id='LC32'><span class="nb">mark_as_advanced</span> <span class="p">(</span><span class="s">GSL_LIB</span> <span class="s">GSL_CBLAS_LIB</span> <span class="s">GSL_INCLUDES</span><span class="p">)</span></div></pre></div>
            </td>
          </tr>
        </table>
  </div>
...
<div id="jump-to-line" style="display:none">
  ...
  <div class="site-footer">
    ...
    <ul class="site-footer-links">
      <li>&copy; 2013 <span title="0.04749s from github-fe127-cp1-prd.iad.github.net">GitHub</span>, Inc.</li>
